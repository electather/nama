...
const (
	...
	HealthServiceName = "nama.api.v1.HealthService"
)
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := File_nama_api_v1_health_proto.Services().ByName("HealthService").Methods()
	return &healthServiceClient{
		check: connect.NewClient[CheckRequest, CheckResponse](
			httpClient,
...
func (c *healthServiceClient) Check(ctx context.Context, req *connect.Request[CheckRequest]) (*connect.Response[CheckResponse], error) {
