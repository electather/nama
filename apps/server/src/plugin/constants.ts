...
const MAXIMUM_LAUNCH_DOCUMENT_KIBIBYTES = 64;
const MAXIMUM_LAUNCH_DOCUMENT_BYTES = MAXIMUM_LAUNCH_DOCUMENT_KIBIBYTES * KIBIBYTE_BYTES;
...
const PLUGIN_IDLE_GRACE_MILLISECONDS = 30_000;
