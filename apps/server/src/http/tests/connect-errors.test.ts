...
const mappedFailureCases = [
  ...
  [
    ...
    { _tag: "DeviceAuthorizationCodeInvalid", userCode: UNSAFE_BEARER },
    Code.InvalidArgument,
    "DEVICE_AUTHORIZATION_CODE_INVALID",
    [UNSAFE_BEARER],
  ],
  [
    "expired device authorization",
    { _tag: "DeviceAuthorizationExpired", userCode: UNSAFE_BEARER },
    Code.FailedPrecondition,
    "DEVICE_AUTHORIZATION_EXPIRED",
    [UNSAFE_BEARER],
  ],
  [
    "already processed device authorization",
    { _tag: "DeviceAuthorizationAlreadyProcessed", userCode: UNSAFE_BEARER },
    Code.FailedPrecondition,
    "DEVICE_AUTHORIZATION_ALREADY_PROCESSED",
    [UNSAFE_BEARER],
  ],
  [
    "session-mismatched device authorization",
    { _tag: "DeviceAuthorizationAccessDenied", userCode: UNSAFE_BEARER },
