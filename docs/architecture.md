...
[ADR-0035](adr/0035-first-party-jellyfin-server-extension.md) and tracked by
...
35. [ADR-0035 — Require a first-party Jellyfin server extension](adr/0035-first-party-jellyfin-server-extension.md)
