...
- Build Swift CodeQL manually for one host-architecture macOS scheme destination; default Swift autobuild selects an unqualified Release target, rebuilds universal AetherEngine dependencies, and eventually fails dependency module resolution.
