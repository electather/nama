...
- Format compact Jellyfin UUID item references as hyphenated UUIDs and omit cache tags in public artwork locator requests so stored private references never appear verbatim in the locator.
