...
- Treat failed issue-executor remote probes as unknown rather than branch absence; preserve publication-only retry intent across stale locks, and reconcile an exact published draft and worktree idempotently without dropping assignment.
